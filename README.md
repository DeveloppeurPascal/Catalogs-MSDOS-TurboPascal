...
Three [Turbo Pascal](https://fr.wikipedia.org/wiki/Turbo_Pascal) projects dating from 1991 to manage a list of books or software on K7 and floppy disks.

These programs run under Dos on the command line. They produce binary files in old-fashioned database format. Lists can be exported in text format for printing or use in other software.
